...
import com.victor.myclient.adapters.GuideViewPagerAdapter;
...
//         如果切换到后台，就设置下次不进入功能引导页
        Utils.putIntValue(WelcomeActivity.this, "RUN_COUNT", 1);
        finish();
    }
    ...
    private void enterMainActivity() {
        Intent intent = new Intent(WelcomeActivity.this,
                LoginActivity.class);
        Utils.startActivity(WelcomeActivity.this, intent);
        finish();
    }
